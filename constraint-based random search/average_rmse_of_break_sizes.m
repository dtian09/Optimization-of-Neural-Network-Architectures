...
%y, a row vector of outputs of a network
...
mask40_test = create_mask(testTargets,40);
...
testTargets40 = testTargets .* mask40_test;
...
rmse40_test = rmse(testOutputs40,testTargets40);
...
if (isnan(rmse40_test)==0)
  average_rmse = average_rmse + rmse40_test;
else
    disp('rmse40_test is Nan');
end
...
rmses = [rmse0_test rmse20_test rmse40_test rmse50_test rmse60_test rmse75_test rmse100_test rmse120_test rmse160_test rmse200_test];
